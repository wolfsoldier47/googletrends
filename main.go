...
func main() {
	...
	fmt.Println("Below are all google Search Trends for Today!")
	fmt.Println("----------------------------------------------")
	for i := range r.Channel.ItemList {
		...
		fmt.Println("Headlin:", r.Channel.ItemList[i].NewsItems[0].Headline)
...
func getGoogleTrends() *http.Response {
	var link string = "https://trends.google.com/trending/rss?geo=MY"
